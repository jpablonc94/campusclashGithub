...
/**
 * Block campusclash helper class.
 *
 * @package    block_campusclash
 * @copyright  2015 Willian Mano http://willianmano.net
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_campusclash_helper {
    ...
    public static function observer(\core\event\base $event) {
        ...
        if ($event->eventname == '\mod_quiz\event\attempt_submitted') {
            ...
            if ($objectid) {
                ...
                block_campusclash_manager::add_user_points($objectid, $grade);
            }
        ...
        block_campusclash_manager::add_user_points($event->objectid);
    }
